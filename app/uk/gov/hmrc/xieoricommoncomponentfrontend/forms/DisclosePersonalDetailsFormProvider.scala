...
class DisclosePersonalDetailsFormProvider @Inject() extends Mappings {

  def apply(): Form[DisclosePersonalDetails] =
    Form("value" -> enumerable[DisclosePersonalDetails]("disclosePersonalDetails.error.required"))
