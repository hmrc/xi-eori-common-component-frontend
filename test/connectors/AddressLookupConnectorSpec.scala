...
import connectors.AddressLookupConnectorSpec.{jsonResponseWithOneResult, jsonResponseWithTwoResults}
...
class AddressLookupConnectorSpec
    extends BaseSpec with MockitoSugar with BeforeAndAfterEach with ScalaFutures with IntegrationPatience {
